...
class _ApiService implements ApiService {
  ...
  @override
  Future<List<PetModel>> getPetsByBreedId(String breedId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'breed_ids': breedId};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<PetModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'images/search',
  ...
  Future<PetModel> getPetDetails(String id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PetModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'images/${id}',
  ...
  Future<SetFavoriteResponse> setFavorite(
    SetFavoriteBody setFavoriteBody,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(setFavoriteBody.toJson());
    final _options = _setStreamType<SetFavoriteResponse>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SetFavoriteResponse _value;
    try {
      _value = SetFavoriteResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
